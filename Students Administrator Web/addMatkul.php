    ...
    <div class="utama">
        ...
        <form method="post" action="sv_addMatkul.php" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="idmatkul" id="nim" required>
            </div>
            <div class="form-group">
                <label for="nama">Nama Matkul:</label>
                <input class="form-control" type="text" name="namamatkul" id="nama">
            </div>
            <div class="form-group">
                <label for="email">SKS:</label>
                <input class="form-control" type="number" name="sks" id="email">
            </div>
            <div class="form-group">
                <label for="email">Jenis:</label>
                <input class="form-control" type="text" name="jns" id="email">
            </div>
            <div class="form-group">
                <label for="email">Semester:</label>
                <input class="form-control" type="text" name="smt" id="email">
            </div>
            <div>
